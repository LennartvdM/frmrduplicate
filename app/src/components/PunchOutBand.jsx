...
// A coloured band with a video-shaped hole punched out of it. The rest
// of the codebase calls that hole a "punch-out"; this used to be the
// only place calling it a cookie cutter.
export default function PunchOutBand({ 
  bandColor = "#edf2f8",
  bandHeight = 320
}) {
