...
import ScrollSnap from '../../site/motion/ScrollSnap';
import SectionManager from '../../site/motion/SectionManager';
...
const WorldMapSection = lazy(() => import('../../site/worldmap/WorldMapSection'));
