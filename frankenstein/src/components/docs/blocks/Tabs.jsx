...
export default function Tabs({ children }) {
  ...
  return (
    <div className="docs-tabs" style={{ margin: '20px 0', border: '1px solid rgba(28, 54, 100, 0.08)', borderRadius: 10, overflow: 'hidden' }}>
      <div
        role="tablist"
        style={{
          display: 'flex',
          gap: 0,
          borderBottom: '1px solid rgba(28, 54, 100, 0.08)',
