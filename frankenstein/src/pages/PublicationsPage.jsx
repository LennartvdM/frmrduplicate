/**
 * Publications page — frmrduplicate styling + neoflixexporttest content.
 * Uses the shared SidebarLayout with video backdrop and scroll-spy,
 * styled to match frmrduplicate's dark teal Publications design.
 */
...
export default function PublicationsPage() {
  ...
  // Slow down videos for ambient background effect
  useEffect(() => {
  ...
  // Set page background color while on Publications
  useEffect(() => {
  ...
  // Section renderer — matches frmrduplicate's publications styling
