...
function r(e, a) {
  return {
    bodyClassName: "framer-body-x05wlhCdy",
    breakpoints: [
      { hash: "ipkpbh", mediaQuery: "(min-width: 1200px)" },
      {
        hash: "nb8wd6",
        mediaQuery: "(min-width: 810px) and (max-width: 1199px)",
      },
      { hash: "valxep", mediaQuery: "(max-width: 809px)" },
    ],
    description: getSiteMetadata(e, a).description,
    elements: {},
    robots: "max-image-preview:large",
    title: getSiteMetadata(e, a).title || "Toolbox",
