...
function r(e, a) {
  return {
    bodyClassName: "framer-body-nzfaDOFRY",
    breakpoints: [
      { hash: "969sk0", mediaQuery: "(min-width: 1200px)" },
      {
        hash: "1edoao6",
        mediaQuery: "(min-width: 810px) and (max-width: 1199px)",
      },
      { hash: "n4uyhk", mediaQuery: "(max-width: 809px)" },
    ],
    description: getSiteMetadata(e, a).description,
    elements: {},
    robots: "max-image-preview:large",
    title: getSiteMetadata(e, a).title || "Toolbox_Let's_Neoflix",
