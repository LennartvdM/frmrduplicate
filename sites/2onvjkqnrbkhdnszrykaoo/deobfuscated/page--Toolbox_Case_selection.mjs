/* CSS extracted to: page--Toolbox_Case_selection.css */
      ...
      jsx(CursorContext.Provider, {
        ...
        children: jsxs(LayoutGroup, {
          ...
          children: [
            jsxs(motion.div, {
              ...T,
              className: cx(L, ...I, "framer-ei83m9", o),
              ref: i ?? D,
              style: { ...a },
              children: [
            ...
            jsx("div", { className: cx(L, ...I), id: "overlay" }),
          ],
        }),
      })
    );
