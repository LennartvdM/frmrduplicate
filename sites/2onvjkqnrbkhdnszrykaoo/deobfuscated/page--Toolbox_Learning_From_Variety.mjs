/* CSS extracted to: page--Toolbox_Learning_From_Variety.css */
      ...
      jsx(CursorContext.Provider, {
        ...
        children: jsxs(LayoutGroup, {
          ...
          children: [
            jsxs(motion.div, {
              ...L,
              className: cx(Y, ..._, "framer-1kh1fjx", o),
              ref: i ?? S,
              style: { ...a },
              children: [
