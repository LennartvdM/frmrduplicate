...
var Y = "framer-QWLgG",
  ...
  U = C(function (v, o) {
    let { activeLocale: m, setLocale: n } = k(),
      ...
      e(N.Provider, {
        ...
        children: f(j, {
          ...
          children: [
            f(c.div, {
              ...P,
              className: p(Y, ...L, "framer-1britxi", i),
              ref: o ?? R,
              style: { ...a },
              children: [
                e(A, {
            ...
            e("div", { className: p(Y, ...L), id: "overlay" }),
          ],
        }),
      })
    );
