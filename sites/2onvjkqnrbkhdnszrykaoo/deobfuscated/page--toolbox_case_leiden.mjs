...
var P = "framer-vWnxi",
  ...
  U = Y(function (b, o) {
    let { activeLocale: r, setLocale: s } = X(),
      ...
      e(T.Provider, {
        ...
        children: l(V, {
          ...
          children: [
            l(p.div, {
              ...Q,
              className: x(P, ...W, "framer-wr5ha4", i),
              ref: o ?? z,
              style: { ...n },
              children: [
                e(S, {
            ...
            e("div", { className: x(P, ...W), id: "overlay" }),
          ],
        }),
      })
    );
