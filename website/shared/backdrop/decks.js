 ...
 */
import { STORIES } from '../../pages/home/story/story.data';
import {
  deckSources as neoflixDeck,
  sectionToVideo as neoflixMap,
} from '../../pages/neoflix/backdrop';
import {
  deckSources as publicationsDeck,
  sectionToVideo as publicationsMap,
} from '../../pages/publications/content';
import { assetUrl } from '../../lib/utils/assetUrl';

export const MEDICAL_PRESSURE_DECK = STORIES.pressure.blurVideos.map((b) => b.video);
export const MEDICAL_REFLECTION_DECK = STORIES.reflection.blurVideos.map((b) => b.video);
